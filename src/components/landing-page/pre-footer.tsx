...
const PreFooter = () => {
  return (
    <>
      <section className="flex flex-col px-3 my-16 md:my-0 md:py-[88px] md:px-[60px] lg:px-[170px] lg:py-[88px]">
        <div className="  flex w-full rounded-[25px] bg-[url('/bg-primary.svg')] pt-12 md:px-[70px] md:pt-[50px] lg:pt-[88px] lg:py-[88px] shadow-xl">
