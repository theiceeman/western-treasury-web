      ...
      <div className="flex w-full flex-col  gap-10 px-5 pb-5 xl:w-[85%] ">
        <div className="flex bg-white">
          <div
            ...
            className="flex w-full gap-5 overflow-x-auto rounded-sm  px-5 py-5"
          >
        ...
        <div className="flex flex-row gap-2 lg:gap-5 rounded-sm bg-white px-3 lg:px-5 py-5">
          <div
            onClick={openModal}
            className="flex w-1/2 cursor-pointer flex-row justify-center gap-2 rounded-sm border px-5 py-5 hover:border-secondary"
          >
